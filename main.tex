...
\begin{titlepage}
    ...
    \includegraphics[width=0.65\textwidth, keepaspectratio]{Figures/yourextremehero.jpg}\par
    
    \vfill
    
    \begin{tcolorbox}[colback=lightgray, colframe=navyblue, width=0.92\textwidth, arc=2.5mm, boxrule=1pt, boxsep=1.5mm]
    \centering
    \small\sffamily
