...
\begin{titlepage}
    ...
    \begin{tcolorbox}[
        ...
        \includegraphics[width=\linewidth]{figures/hero_forside.png}
    \end{tcolorbox}
    \end{center}
    
    \vfill
    
    \begin{tcolorbox}[colback=lightgray, colframe=navyblue, width=0.95\textwidth, arc=2.5mm, boxrule=1pt, boxsep=1.5mm, center]
    \centering
    \small\sffamily
